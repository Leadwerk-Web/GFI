...
(function () {
  ...
  (function initRequestForm() {
    ...
    form.addEventListener("submit", function (e) {
      ...
      if (firstInvalid) {
        showFormError("Bitte prüfen Sie die markierten Felder. Anschließend können Sie die Nachricht übermitteln.");
        firstInvalid.focus();
        return;
      }
      ...
      fetch(endpoint, {
        ...
        .catch(function () {
          showFormError(
            "Ihre Nachricht konnte gerade nicht übermittelt werden. Bitte versuchen Sie es erneut oder " +
